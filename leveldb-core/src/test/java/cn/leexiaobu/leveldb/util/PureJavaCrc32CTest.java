...
import static cn.leexiaobu.leveldb.util.PureJavaCrc32C.mask;
import static cn.leexiaobu.leveldb.util.PureJavaCrc32C.unmask;
...
public class PureJavaCrc32CTest {
  ...
  public Object[][] data() {
    return new Object[][]{new Object[]{0x8a9136aa, arrayOf(32, (byte) 0)},
        ...
        new Object[]{0xd9963a56, arrayOf(
            new int[]{0x01, 0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00,
                0x14, 0x00, 0x00, 0x00, 0x18, 0x28, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
  ...
  public void testMask() throws UnsupportedEncodingException {
    ...
    assertFalse(crc.getIntValue() == mask(crc.getMaskedValue()),
