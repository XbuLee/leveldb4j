...
public abstract class TableTest {
  ...
  protected abstract Table createTable(String name, FileChannel fileChannel,
      Comparator<Slice> comparator, boolean verifyChecksums) throws IOException;
  ...
  public void testMultipleEntriesWithMultipleBlock() throws Exception {
    ...
    // about 3 blocks
    tableTest(BlockHelper.estimateBlockSize(Integer.MAX_VALUE, entries) / 3, Integer.MAX_VALUE,
        entries);
  }
  ...
  public void setUp() throws Exception {
    reopenFile();
    checkState(0 == fileChannel.position(), "Expected fileChannel.position %s to be 0",
