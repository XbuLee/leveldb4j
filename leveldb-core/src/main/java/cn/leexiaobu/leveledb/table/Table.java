...
import cn.leexiaobu.leveledb.impl.SeekingIterable;
import cn.leexiaobu.leveledb.util.Closeables;
import cn.leexiaobu.leveledb.util.Slice;
import cn.leexiaobu.leveledb.util.TableIterator;
import cn.leexiaobu.leveledb.util.VariableLengthQuantity;
...
public abstract class Table implements SeekingIterable<Slice, Slice> {
  ...
  public Table(String name, FileChannel fileChannel, Comparator<Slice> comparator,
      boolean verifyChecksums) throws IOException {
    requireNonNull(name, "name is null");
    requireNonNull(fileChannel, "fileChannel is null");
    long size = fileChannel.size();
    checkArgument(size >= Footer.ENCODED_LENGTH, "File is corrupt: size must be at least %s bytes",
