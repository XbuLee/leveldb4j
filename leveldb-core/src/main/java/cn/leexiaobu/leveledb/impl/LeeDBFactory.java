...
import cn.leexiaobu.leveledb.util.FileUtils;
 ...
 */
public class LeeDBFactory implements DBFactory {
  ...
  public static final LeeDBFactory factory = new LeeDBFactory();
  ...
  static {
    String v = "unknown";
    InputStream is = LeeDBFactory.class.getResourceAsStream("version.txt");
    try {
