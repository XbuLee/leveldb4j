...
import static cn.leexiaobu.leveledb.impl.LogChunkType.BAD_CHUNK;
import static cn.leexiaobu.leveledb.impl.LogChunkType.EOF;
import static cn.leexiaobu.leveledb.impl.LogChunkType.UNKNOWN;
import static cn.leexiaobu.leveledb.impl.LogChunkType.ZERO_TYPE;
import static cn.leexiaobu.leveledb.impl.LogChunkType.getLogChunkTypeByPersistentId;
import static cn.leexiaobu.leveledb.impl.LogConstants.BLOCK_SIZE;
import static cn.leexiaobu.leveledb.impl.LogConstants.HEADER_SIZE;
import static cn.leexiaobu.leveledb.impl.Logs.getChunkChecksum;

import cn.leexiaobu.leveledb.util.DynamicSliceOutput;
...
public class LogReader {
  ...
  public LogReader(FileChannel fileChannel, LogMonitor monitor, boolean verifyChecksums,
      long initialOffset) {
