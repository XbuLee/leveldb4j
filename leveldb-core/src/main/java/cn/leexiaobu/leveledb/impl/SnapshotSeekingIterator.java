...
import cn.leexiaobu.leveledb.util.AbstractSeekingIterator;
...
public final class SnapshotSeekingIterator extends AbstractSeekingIterator<Slice, Slice> {
  ...
  public SnapshotSeekingIterator(DbIterator iterator, SnapshotImpl snapshot,
  ...
  public String toString() {
    String sb = "SnapshotSeekingIterator"
        + "{snapshot=" + snapshot
        + ", iterator=" + iterator
        + '}';
    return sb;
