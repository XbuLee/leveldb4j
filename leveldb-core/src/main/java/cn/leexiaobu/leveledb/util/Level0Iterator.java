...
import cn.leexiaobu.leveledb.impl.FileMetaData;
import cn.leexiaobu.leveledb.impl.InternalKey;
import cn.leexiaobu.leveledb.impl.SeekingIterator;
import cn.leexiaobu.leveledb.impl.TableCache;
...
public final class Level0Iterator extends AbstractSeekingIterator<InternalKey, Slice> implements
    InternalIterator {
  ...
  public Level0Iterator(TableCache tableCache, List<FileMetaData> files,
  ...
  private static class ComparableIterator implements Iterator<Entry<InternalKey, Slice>>,
    ...
    private ComparableIterator(SeekingIterator<InternalKey, Slice> iterator,
        Comparator<InternalKey> comparator, int ordinal, Entry<InternalKey, Slice> nextElement) {
    ...
    public boolean equals(Object o) {
      ...
      return Objects.equals(nextElement, comparableIterator.nextElement);
    }
