...
import cn.leexiaobu.leveldb.impl.InternalKeyComparator;
import cn.leexiaobu.leveldb.impl.TableCache;
import java.util.List;
import java.util.Map.Entry;


public final class LevelIterator extends AbstractSeekingIterator<InternalKey, Slice> implements
    InternalIterator {
  ...
  public LevelIterator(TableCache tableCache, List<FileMetaData> files,
