 ...
 */
package cn.leexiaobu.leveldb.util;
...
public final class SliceInput extends InputStream implements DataInput {
   ...
   *
   * @throws IndexOutOfBoundsException if the specified {@code position} is less than {@code 0} or
  ...
  /**
   * Returns {@code true} if and only if {@code available()} is greater than {@code 0}.
   */
  ...
  /**
   * Gets a byte at the current {@code position} and increases the {@code position} by {@code 1} in
   * this buffer.
   *
  ...
  /**
   * Gets an unsigned byte at the current {@code position} and increases the {@code position} by
  ...
  /**
   * Gets a 16-bit short integer at the current {@code position} and increases the {@code position}
  ...
  /**
   * Gets a 32-bit integer at the current {@code position} and increases the {@code position} by
  ...
  /**
   * Gets an unsigned 32-bit integer at the current {@code position} and increases the
   * {@code position} by {@code 4} in this buffer.
   *
   * @throws IndexOutOfBoundsException if {@code this.available()} is less than {@code 4}
   */
  ...
  /**
   * Gets a 64-bit integer at the current {@code position} and increases the {@code position} by
  ...
  /**
   * Transfers this buffer's data to a newly created buffer starting at the current {@code position}
   * and increases the {@code position} by the number of the transferred bytes (= {@code length}).
   * The returned buffer's {@code position} and {@code writerIndex} are {@code 0} and {@code length}
   * respectively.
   *
  ...
  /**
   * Returns a new slice of this buffer's sub-region starting at the current {@code position} and
   * increases the {@code position} by the size of the new slice (= {@code length}).
   *
   ...
   * {@code position} and increases the {@code position} by the number of the transferred bytes (=
   * {@code dst.length}).
   *
   ...
   * @param length the number of bytes to transfer
   * @throws IndexOutOfBoundsException if the specified {@code destinationIndex} is less than
   * {@code 0}, if {@code length} is greater than {@code this.available()}, or if
   * {@code destinationIndex + length} is greater than {@code destination.length}
   */
  ...
  /**
   * Transfers this buffer's data to the specified destination starting at the current
   * {@code position} until the destination becomes non-writable, and increases the {@code position}
   * by the number of the transferred bytes.  This method is basically same with
   * {@link #readBytes(Slice, int, int)}, except that this method increases the {@code writerIndex}
   * of the destination by the number of the transferred bytes while
   * {@link #readBytes(Slice, int, int)} does not.
   *
   ...
   * Transfers this buffer's data to the specified destination starting at the current
   * {@code position} and increases the {@code position} by the number of the transferred bytes (=
   * {@code length}).  This method is basically same with {@link #readBytes(Slice, int, int)},
   * except that this method increases the {@code writerIndex} of the destination by the number of
   * the transferred bytes (= {@code length}) while {@link #readBytes(Slice, int, int)} does not.
   *
   ...
   * @throws IndexOutOfBoundsException if the specified {@code destinationIndex} is less than
   * {@code 0}, if {@code length} is greater than {@code this.available()}, or if
   * {@code destinationIndex + length} is greater than {@code destination.capacity}
   */
  ...
  /**
   * Transfers this buffer's data to the specified destination starting at the current
   * {@code position} until the destination's position reaches its limit, and increases the
   * {@code position} by the number of the transferred bytes.
   *
   ...
   * This method is identical to {@code buf.slice(buf.position(), buf.available()())}. This method
   * does not modify {@code position} or {@code writerIndex} of this buffer.
   */
  public Slice slice() {
   ...
   * method is identical to {@code buf.toByteBuffer(buf.position(), buf.available()())}. This method
   * does not modify {@code position} or {@code writerIndex} of this buffer.
   */
  ...
  /**
   * Decodes this buffer's readable bytes into a string with the specified character set name.  This
   * method is identical to {@code buf.toString(buf.position(), buf.available()(), charsetName)}.
   * This method does not modify {@code position} or {@code writerIndex} of this buffer.
   *
   * @throws java.nio.charset.UnsupportedCharsetException if the specified character set name is not
   * supported by the current VM
   */
