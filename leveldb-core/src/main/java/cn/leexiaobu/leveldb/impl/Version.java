...
import static cn.leexiaobu.leveldb.impl.DbConstants.MAX_MEM_COMPACT_LEVEL;
...
import static cn.leexiaobu.leveldb.impl.VersionSet.MAX_GRAND_PARENT_OVERLAP_BYTES;
...
import cn.leexiaobu.leveldb.util.InternalTableIterator;
import cn.leexiaobu.leveldb.util.LevelIterator;
...
public class Version implements SeekingIterable<InternalKey, Slice> {
  ...
  public Version(VersionSet versionSet) {
    ...
    this.level0 = new Level0(new ArrayList<FileMetaData>(), getTableCache(),
